const SEED_SKILLS = [
  ...
  {
    id: 's15', name: 'VaporAviator Lab Style', path: 'vaporaviator/lab-style', installs: '16.8K', color: 'bg-violet-950', icon: 'L', type: 'Aesthetic', avatar: 'https://unavatar.io/twitter/VaporAviator', description: 'Space-Age Minimalist with a Vaporwave soul — Space Grotesk + Inter, dark-first palette with lavender accent, tight 8px grid.', github: 'https://github.com/VaporAviator/vaporaviator-lab-style', website: '', stars: '—', highlighted: false,
    securityScan: { status: 'passed', scannedAt: '2026-03-13T19:30:00.000Z', source: 'SKILL.md', dimensions: [{ name: 'Code Injection', status: 'pass', flags: [] }, { name: 'Data Exfiltration', status: 'pass', flags: [] }, { name: 'Credential Access', status: 'pass', flags: [] }, { name: 'File System Risk', status: 'pass', flags: [] }, { name: 'Network & Persistence', status: 'pass', flags: [] }], permissionScopes: [{ name: 'File System Write', detected: false, flags: [] }, { name: 'Network Access', detected: false, flags: [] }, { name: 'Env Variable Access', detected: false, flags: [] }] },
  },
  {
    id: 's14', name: 'Theme Factory', path: 'anthropics/theme-factory', installs: '21.4K', color: 'bg-orange-50', icon: 'TF', type: 'Aesthetic', avatar: 'https://unavatar.io/github/anthropics', description: '10 pre-set themes with curated color palettes and font pairings — apply to slides, docs, HTML pages, and any artifact.', github: 'https://github.com/anthropics/skills/tree/main/skills/theme-factory', website: '', stars: '92.7K',
